...
def run_estimation() -> None:
    """Estimate the complexity of the repair algorithm (polynomial vs. exponential).

    Uses hardcoded data points from the paper experiments, ignoring
    bctt and co-wheat as outliers.
    """
